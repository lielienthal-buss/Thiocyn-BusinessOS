...
export async function submitApplication(formData: ApplicationFormData) {
  const payload = {
    ...
    captcha_verified: true, // Explicitly set to true for RLS policy
    stage: 'applied', // Explicitly set default stage for RLS policy
    // 'access_token' is generated by default in the DB
  };

  console.log('Supabase Insert Payload:', JSON.stringify(payload, null, 2)); // Added console.log for payload
  ...
  if (error) {
    ...
    console.error('Supabase Error Object:', error); // Added console.error for full object

// types.ts - V2 Update for Lean, Evidence-Based Hiring (Revision 2)
 ...
 * V2 fields are marked as optional/nullable to gracefully handle legacy data.
 */
export interface Application {
  ...
  psychometrics: { [key: string]: number } | null;
  
  // V2 Workflow Management
  stage: ApplicationStage;
  access_token: string; // This is generated by default on insert, so it should always exist.

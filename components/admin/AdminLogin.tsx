  ...
  return (
    <div className="relative min-h-[80vh] flex items-center justify-center overflow-hidden">
      ...
      <div className="absolute inset-0 pointer-events-none">
        <div className="absolute top-[-10%] left-[-5%] w-[45%] h-[45%] bg-primary-600/15 rounded-full blur-[150px] animate-blob" />
            ...
            <div className="animate-slide-up-3 space-y-5">
              <div className="p-5 rounded-2xl bg-primary-500/5 border border-primary-500/10 text-center">
                ...
                <button type="button" onClick={startDemo}
                  className="group w-full py-4 bg-gray-900 hover:bg-primary-600 text-white rounded-xl font-black text-xs uppercase tracking-[0.2em] transition-all duration-300 shadow-xl hover:shadow-primary-500/30 hover:scale-[1.02] active:scale-[0.98]">

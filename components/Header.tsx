  ...
  return (
    <header className="p-12 rounded-[3.5rem] flex flex-col md:flex-row items-center gap-10 shadow-2xl bg-gray-900/30 backdrop-blur-2xl border border-white/20">
      ...
      <div className="text-center md:text-left">
        ...
        {/* Added tagline */}
        <p className="text-lg text-gray-600 dark:text-gray-400 font-medium max-w-xl leading-relaxed">
          Become part of a team that doesn&apos;t just solve problems, it pulverizes
          them. Send us your documents directly through our encrypted portal.
        </p>
      </div>
    </header>
  );

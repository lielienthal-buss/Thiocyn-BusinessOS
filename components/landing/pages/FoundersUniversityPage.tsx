...
const COPY = {
  de: {
    ...
    trackRecordBody: 'Founders University wurde von ehemaligen Fellows aus dem ersten Cohort aufgebaut — beide übernommen, beide gestalten heute aktiv mit. Das ist kein Praktikum-Programm, das eine HR-Abteilung am Reißbrett designed hat. Es ist gebaut von Leuten, die selbst durchgelaufen sind.',
  ...
  en: {
    ...
    trackRecordBody: 'Founders University was built by former fellows from the first cohort — both hired, both actively shaping the program today. This is not an internship program designed by an HR department on paper. It is built by people who went through it themselves.',

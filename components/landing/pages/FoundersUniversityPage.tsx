...
const COPY = {
  de: {
    ...
    trackRecordHeading: 'Wer Impact bringt, bleibt.',
    trackRecordBody: 'Wer im Programm wirklich was bewegt, hat eine echte Chance auf Übernahme. Nicht garantiert, nicht versprochen — aber real. Die zwei, die Founders University heute mitgestalten, haben diesen Weg selbst gemacht: Praktikant im ersten Durchgang, dann übernommen, jetzt im Team.',
  ...
  en: {
    ...
    trackRecordHeading: 'Bring impact, stay.',
    trackRecordBody: 'Move things in the program and there is a real shot at a permanent role. Not promised, not guaranteed — but real. The two people building Founders University today went that exact path: interns in the first batch, hired, now part of the team.',

...
_This section documents the major architectural changes for the V2 overhaul._
...
_These are the original decisions for the project. Their current status is noted._
